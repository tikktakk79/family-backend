...
var User = (_User = {
  ...
  getUserLevel: function getUserLevel(req, res) {
...
}, _defineProperty(_User, "getUserLevel", function getUserLevel(req, res) {
  return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var createQuery, rows;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          createQuery = "SELECT accessgroup\n    FROM user\n    WHERE username LIKE ?";
          _context6.prev = 1;
...
}), _defineProperty(_User, "searchUsers", function searchUsers(req, res) {
...
}), _defineProperty(_User, "verifyAccount", function verifyAccount(req, res) {
